    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div>
        ...
        <div style={{ background: "#f9fafb", borderRadius: 10, padding: "1rem", border: "1px solid #f0f0f0" }}>
          <div style={{ fontFamily: fontFamily, fontWeight, fontSize: 24, color: "#111", marginBottom: 4 }}>{name}</div>
          <div style={{ fontFamily: fontFamily, fontWeight: "400", fontSize: 14, color: "#6b7280", marginBottom: 8 }}>The quick brown fox jumps over the lazy dog</div>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ background: palette.bg, borderRadius: 8, padding: "1rem", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: fontFamily, fontWeight, fontSize: 16, color: logo.textColor }}>{name}</span>
          </div>
          {/* Light bg */}
          <div style={{ background: "#ffffff", borderRadius: 8, padding: "1rem", border: "1px solid #f0f0f0", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: fontFamily, fontWeight, fontSize: 16, color: "#111111" }}>{name}</span>
          </div>
          {/* Icon only */}
